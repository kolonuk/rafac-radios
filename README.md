...
- **Admin Portal**:
    ...
    - Integrated version update check.

![Tutor Dashboard](static/screenshots/tutor_dashboard.png)
...
### Versioning
When submitting a Pull Request, please ensure you increment the version number in `main.go`:
```go
const AppVersion = "v1.0.1" // Increment this!
```
